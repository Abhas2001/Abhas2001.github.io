...
const Navigation = () => {
  ...
  return (
    <section>
    <section className='w-full max-h-[80%] p-5 border-1 border-b-2 border-[#484848]'>
      <section className='w-full min-h-full p-4 flex justify-between text-[#C7C7C7]'>
       <div>
        portfolio
       </div>

       <div className='flex gap-16'>
        <button className='flex justify-start font-serif' onClick={()=>{setWork('project')}}>Work</button>
        <button className='flex justify-start'>About</button>
